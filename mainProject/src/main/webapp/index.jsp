...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(images/fantastic.jpg);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2">LearningMan</h1>
            <div class="intro-text text-center text-md-left">
              <p class="mb-4">"As a culture, we are moving from a group of people who know it all to a group of people who want to learn it all." <font size="3" color="grey">-Satya Nadella</font></p>
              <p>
                <a href="loginForm.jsp" class="btn btn-sm btn-primary">시작하기</a>
              </p>
            </div>
          </div>
        </div>
